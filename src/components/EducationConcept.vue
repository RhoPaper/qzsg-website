      ...
      <div class="concept-container">
        ...
        <div class="concept-content" ref="contentContainer">
          ...
          <p class="concept-text fade-in-up" ref="text1">
            我们的教育理念建立在尊重儿童天性、激发学习潜能的基础上。我们相信，每个孩子都是独特的个体，拥有无限的创造力和学习能力。我们致力于为孩子提供一个安全、温馨、充满挑战的学习环境，让孩子在玩中学、学中玩，全面发展智力、情感、社交和身体素质。
          </p>
          <p class="concept-text fade-in-up" ref="text2">
            我们注重培养孩子的独立思考能力、解决问题的能力、团队合作精神以及对世界的好奇心和探索欲。我们相信，通过科学的教育方法和丰富多彩的课程设置，可以帮助每个孩子发现自己的兴趣和天赋，为未来的成长奠定坚实的基础。
          </p>
